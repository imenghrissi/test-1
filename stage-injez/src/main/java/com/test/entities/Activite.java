...
public Activite(String code_Activite, Integer id_projet, String code_Parag, String act_Reference_Projet,
		String act_Code_Activite, String des, Integer cout_FE, Integer cout_Autre, Integer flag_Niveau, String obs,
		Integer nbr_Fils, String code, Integer nivau_Zone, Integer id_Racine, Integer cout_Fe_Ini,
		Integer cout_Autre_Ini, Integer tre, Integer avan_Act, Date dt_Act_Tre, Date dt_Act_Tot, Integer ordre_Act,
		String justification, Date dat_Deb, Date dat_Fin, Integer id_Type_Decoup, Date dat_Deb_Act, Date dat_Fin_Act,
		Integer flag_Action_Individuel, Integer f_Biens, Integer f_Travaux, Integer f_Services, Integer flag_Mstr,
		Integer flag_Deleg, String des_Ar, String obs_Ar, Integer cout_Total, Integer cout_Tr_Ini, Integer cout_Tr,
		Integer cout_Total_Ini, Integer cout_Total_Ml, Integer cout_Total_Ini_Ml, Integer poids, Integer flag_Multi_Op,
		Integer flag_En_Difficulte, String code_Param, String des_Param, String unite, String des_Fe) {
	super();
